    ...
    with st.container():
        ...
        if choose == "About":
            ...
            with st.container():
                ...
                st.write("4. The possibility to download the SyllaView as a CSV-file to your local computer and write your own notes to each article")
        ...
        if choose == "How does it work?":
             ...
             with st.container():
                ...
                st.write("**5. Optical Character Recognition (OCR) for scanned readings**")
